...
<style>
  .lt-card {
    ...
    --_card-header-padding: var(
      --lt-card-header-padding,
      0 0 var(--lt-card-section-gap, 1rem) 0
    );
    --_card-footer-padding: var(
      --lt-card-footer-padding,
      var(--lt-card-section-gap, 1rem) 0 0 0
    );
    --_card-section-border: var(
      --lt-card-section-border,
      var(--lt-color-border-muted, #e6ebf1)
    );
    display: grid;
    gap: var(--_card-gap);
