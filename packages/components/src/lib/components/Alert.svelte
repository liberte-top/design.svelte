...
<style>
  .lt-alert {
    ...
    --_alert-bg: var(
      --lt-alert-info-bg,
      var(--lt-color-success-surface, #dafbe1)
    );
    --_alert-border: var(
      --lt-alert-info-border,
      var(--lt-color-success-border, #aceebb)
    );
    --_alert-color: var(
      --lt-alert-info-color,
      var(--lt-color-success, #1a7f37)
    );
  ...
  .lt-alert--info {
    ...
    --_alert-border: var(
      --lt-alert-success-border,
      var(--lt-color-success-border, #aceebb)
    );
    --_alert-color: var(
      --lt-alert-success-color,
      var(--lt-color-success, #1a7f37)
    );
  }
  ...
  .lt-alert--error {
    --_alert-bg: var(
      --lt-alert-error-bg,
      var(--lt-color-danger-surface, #ffebe9)
    );
    --_alert-border: var(
      --lt-alert-error-border,
      var(--lt-color-danger-border, #ffcecb)
    );
    --_alert-color: var(
      --lt-alert-error-color,
      var(--lt-color-danger, #cf222e)
    );
  }
</style>
